...
export function inferSelections(files: ModelFile[], turbo: 'off' | '4' | '8', textEncoderPreference: H3TextEncoderPreference = 'fast', diffusionPrecision: H3DiffusionPrecision = 'int8'): ModelSelection {
