...
const { createSceneState, value, parseStyleValues, applySceneCommand, applySceneSuggestions, bindSceneReferences, extractSceneDialogue } = load('src/lib/scenePromptState.ts')
